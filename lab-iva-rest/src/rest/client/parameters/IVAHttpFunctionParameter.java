...
public class IVAHttpFunctionParameter<T> implements HttpParameter {
	
	private Object parameterName;
	private T[] parameterValues;
	
	public IVAHttpFunctionParameter() {
		this.setParameterName(null);
		this.parameterValues = null;
	}
	
	public IVAHttpFunctionParameter(Object parameterName,T...parameterValues) {
