...
public class IVAHttpDeleteRequest extends BaseHttpRequest implements HttpRequest {

	public IVAHttpDeleteRequest() {
		super.setContentType(null);
		super.setInput(null);
		super.setMediaType(MediaType.APPLICATION_JSON);
	}
	
	public IVAHttpDeleteRequest(ContentType contentType, String mediaType, String input) {
